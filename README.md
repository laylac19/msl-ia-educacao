...
## MSL 2 – IA em práticas pedagógicas personalizadas
- Arquivo: `Revisão - Sistemas Inteligentes de Apoio Baseados em IA para o Transtorno do Espectro Autista (TEA).xlsx`
- Período de busca: 2018–2025
- Bases consultadas: 
    - ACM Digital Library - http://dl.acm.org
    - IEEE Xplore - http://ieeexplore.ieee.org
